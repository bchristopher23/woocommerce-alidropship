...
class VI_WOOCOMMERCE_ALIDROPSHIP_Admin_Ali_Orders {
	...
	/**Possible errors when placing orders according to official api document https://developers.aliexpress.com/en/doc.htm?docId=35446&docType=2
	 *
	 * @param $code
	 *
	 * @return mixed|string
                                                            ...
                                                            <div class="<?php esc_attr_e( self::set( 'item-ali-order-container' ) ) ?>">
                                                                ...
                                                                <div class="<?php esc_attr_e( self::set( array(
                                                                    ...
                                                                    <div class="<?php esc_attr_e( self::set( 'item-ali-order-value' ) ) ?>">
                                                                        ...
                                                                        <div class="<?php esc_attr_e( self::set( $get_tracking ) ) ?>">
                                                                            <a href="<?php echo esc_attr( $tracking_url_btn ) ?>"
                                                                               target="_blank">
                                                                                <span class="dashicons dashicons-arrow-down-alt <?php esc_attr_e( self::set( 'item-actions-get-tracking' ) ) ?>"
