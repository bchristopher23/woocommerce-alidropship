...
class VI_WOOCOMMERCE_ALIDROPSHIP_Admin_Error_Images {
	...
	public function menu_product_count() {
		global $submenu;
		$this->settings = VI_WOOCOMMERCE_ALIDROPSHIP_DATA::get_instance();//show_menu_count may be changed after saving settings
		if ( isset( $submenu['woocommerce-alidropship'] ) && in_array( 'failed_images', $this->settings->get_params( 'show_menu_count' ) ) ) {
