...
//				$response['attributes_list_html'] = ob_get_clean();
	...
	public function get_shipping_company_mask() {
		...
		$now = time();
		if ( $page === 1 ) {
			if ( self::$settings->get_params( 'ali_shipping_company_mask_time' ) < $now - DAY_IN_SECONDS ) {
			...
			foreach ( $access_tokens as $at_k => $at_v ) {
				if ( $at_v['access_token'] === $access_token ) {
					if ( $at_v['expire_time'] / 1000 < time() ) {
						$errors[] = sprintf( __( 'Your AliExpress access token expires, products/tracking numbers auto-updating and bulk AliExpress orders no longer work. <a class="vi-wad-get-access-token-shortcut" target="%s" href="%s">Get access token</a>', 'woocommerce-alidropship' ), $page === 'woocommerce-alidropship' ? '' : 'blank', admin_url( 'admin.php?page=woocommerce-alidropship#/update' ) );
					}
					break;
				}
			}
        ...
        <div class="wrap woocommerce-alidropship">
			...
			if ( VI_WOOCOMMERCE_ALIDROPSHIP_DATA::get_disable_wp_cron() ) {
                ...
                <div class="vi-ui message negative">
                    <span><?php _e( '<strong>DISABLE_WP_CRON</strong> is set to true, product images may not be downloaded properly. Please try option <strong>"Disable background process"</strong>', 'woocommerce-alidropship' ) ?></span>
                </div>
				<?php
			}
			?>
                        ...
                        <table class="form-table">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p><?php esc_html_e( 'Default carrier company', 'woocommerce-alidropship' ) ?></p>
                                </td>
                            </tr>
                            <tr>
                                <th>
                    ...
                    <div class="vi-ui bottom attached tab segment <?php self::set_params( 'tab-content', true ) ?>"
                        ...
                        <div class="vi-ui message positive">
                            ...
                            <ul class="list">
                                ...
                                <li><?php esc_html_e( 'The list of available shipping companies will grow in time', 'woocommerce-alidropship' ) ?></li>
                            </ul>
                        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="fields">
                                        ...
                                        <span class="vi-ui button mini green villatheme-get-key-button"
                                    ...
                                    <p><?php echo wp_kses_post( __( 'Please enter the key that you get from <a target="_blank" href="https://villatheme.com/my-download">https://villatheme.com/my-download</a> to enable auto update and use AliExpress API. Please read <a target="_blank" href="https://villatheme.com/knowledge-base/how-to-use-auto-update-feature/">guide</a>', 'woocommerce-alidropship' ) ) ?></p>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                        ...
                        <tr>
                            <th>
                                <label for="<?php self::set_params( 'ignore_ship_from', true ) ?>">
									<?php esc_html_e( 'Ignore import ship from', 'woocommerce-alidropship' ) ?>
                                </label>
                            </th>
                            <td>
                                <div class="vi-ui toggle checkbox">
                                    ...
                                    <label>
										<?php esc_html_e( 'Enable to only import product variations with ship from China', 'woocommerce-alidropship' ) ?>
                                    </label>
                                </div>
                            </td>
                        </tr>
                            ...
                            <div class="field">
                                <div class="vi-ui right labeled input fluid">
                                    ...
                                    <label for="amount" class="vi-ui label"><span
                                                class="vi-ui positive button tiny <?php self::set_params( 'format_price_rules_test_button', true ); ?>"><?php esc_html_e( 'View result', 'woocommerce-alidropship' ) ?></span></label>
                                </div>
                            </div>
